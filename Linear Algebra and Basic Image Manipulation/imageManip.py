...
def rgb_exclusion(image, channel):
    ...
    #this code was added since the input image was from PIL library, and not numpy, 
    # hence i converted the image into numpy using the function numpy.array()
